    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
                ...
                <div class="row g-4 justify-content-between mb-5">
                    <div class="col-lg-6">
                        ...
                        <p class="text-dark mb-0">
                            <i class="fas fa-check-circle text-primary me-1"></i>
                            Aménagement et valorisation du foncier
                        </p>
                    </div>
                    <div class="col-lg-6">
                        <p class="text-dark">
                ...
                <p class="ps-4 mb-4">
                    Depuis sa création, EPE-DELYPRO-SPA déploie ses actions conformément aux orientations stratégiques
                    définies par les Conseils d’Administration successifs, axées principalement sur la réalisation
                    de programmes de logements promotionnels répondant aux besoins du marché.
                </p>

                <!-- Button -->
                <div class="mb-5">
                    <a href="projects.html" class="btn btn-primary rounded-pill py-3 px-5">
