            ...
            <div class="row gx-0 align-items-center" style="height: 45px;">
                ...
                <div class="col-lg-8 text-center text-lg-start mb-lg-0">
                    <div class="d-flex flex-wrap">
                        ...
                        <a href="tel:+213773668929" class="text-muted me-4">
                            <i class="fas fa-phone-alt text-primary me-2"></i>
                            +213 773 66 89 29
                        </a>
                        <a href="mailto:dg.delypro@gmail.com" class="text-muted me-0">
                            <i class="fas fa-envelope text-primary me-2"></i>
                            dg.delypro@gmail.com
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <a href="#" class="btn btn-primary btn-square rounded-circle nav-fill me-3" aria-label="Twitter">
                            <i class="fab fa-twitter text-white"></i>
                        </a>
                        <a href="#" class="btn btn-primary btn-square rounded-circle nav-fill me-3" aria-label="Instagram">
                            <i class="fab fa-instagram text-white"></i>
                        </a>
                        <a href="#" class="btn btn-primary btn-square rounded-circle nav-fill me-0" aria-label="LinkedIn">
